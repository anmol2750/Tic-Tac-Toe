...
label2=Label(root,text=f'SCORE-->PLAYER1: {ScoreX}\nSCORE-->PLAYER2: {ScoreO}',font="Times 15 bold",bg='red',fg='black',bd=4,height=1,width=10,relief=RAISED,)
...
b10=Button(root,font="Times 15 bold",image=b10Photo ,bg='red',fg='white',height=2,width=10)
...
def AssignSeperateColorToWinner(id):
    if id=='R1':
        b1['bg']='light green'
        b2['bg']='light green'
        b3['bg']='light green'
...
def CheckWinner():
    ...
    if ( (1 in p1) and (2 in p1) and (3 in p1) ):
        Winner=1
        AssignSeperateColorToWinner('R1')
    ...
    if ( (4 in p1) and (5 in p1) and (6 in p1) ):
        Winner=1
        AssignSeperateColorToWinner('R2')
    ...
    if ( (7 in p1) and (8 in p1) and (9 in p1) ):
        Winner=1
        AssignSeperateColorToWinner('R3')
    ...
    if ( (1 in p1) and (4 in p1) and (7 in p1) ):
        Winner=1
        AssignSeperateColorToWinner('C1')
    ...
    if ( (2 in p1) and (5 in p1) and (8 in p1) ):
        Winner=1
        AssignSeperateColorToWinner('C2')
    ...
    if ( (3 in p1) and (6 in p1) and (9 in p1) ):
        Winner=1
        AssignSeperateColorToWinner('C3')
    ...
    if ( (1 in p1) and (5 in p1) and (9 in p1) ):
        Winner=1
        AssignSeperateColorToWinner('D1')
    ...
    if ( (3 in p1) and (5 in p1) and (7 in p1) ):
        Winner=1
        AssignSeperateColorToWinner('D2')
